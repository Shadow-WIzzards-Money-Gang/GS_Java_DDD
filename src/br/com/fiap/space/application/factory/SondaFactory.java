...
public class SondaFactory {
    ...
    public static SondaExploradora criarSondaExploradora(Coordenada coordernada, NivelEnergia bateria, Double alcanceSensor) {
        return new SondaExploradora(bateria, coordernada, alcanceSensor);
    }

    public static SondaMineradora criarSondaMineradora(Coordenada coordernada, NivelEnergia bateria, Double volumeMaximo) {
    ...
    public static Sonda criarSonda(TipoSonda tipoSonda, Integer eixoX, Integer eixoY, Double nivelBateria, Double capacidadeMaxima, Double alcanceSensor, Double volumeMaximo) {
        ...
        Coordenada coordernada = new Coordenada(eixoX, eixoY);
